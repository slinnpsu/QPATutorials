...
```
Now we have an x-axis, but still no data because we haven't yet told `ggplot()` *how* to plot the data.  To build our plot, we add additional layers with the plus sign.
