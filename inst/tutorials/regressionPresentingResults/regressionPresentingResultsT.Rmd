...
Set the title for the plot to "Predicted Proportion of House Seats \nHeld by Democrats" and the axis titles to "Proportion Liberal" and "Proportion of Democratic House Seats". Set the `show.data` equal to TRUE to plot the bivariate scatter plot.
