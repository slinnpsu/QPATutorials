...
We use  <span style="color:blue">**Pearson's correlation coefficient, $\rho$**</span>, to estimate the strength and direction of any linear relationship between two interval-level variables. We may wish to test whether this correlation is significantly different from zero. We do so with a correlation test. We use the R function `cor.test()` to conduct this hypothesis test. The function also reports $\rho$.
