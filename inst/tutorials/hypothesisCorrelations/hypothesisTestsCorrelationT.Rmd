...
We can see that the bivariate relationship is negative (about -0.07) -- as mortality risk goes up, so too does the percent of the vote Hillary Clinton won. This correlation is significantly different from zero (p<0.05) and the 95% confidence interval does not include zero. We can, therefore, reject the null hypothesis that the correlation is zero with 95% confidence. Even though the correlation is small, we can be quite confident it is different from zero.
