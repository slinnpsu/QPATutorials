...
question("Select the statements that are true",
  answer("We can be 95% confident that the unevenness of economic development does not affect freedom of the press scores", correct=TRUE, message="Because **ffp_ued** has a p-value greater than 0.05, we cannot reject the null hypothesis for this variable but for all others the p-value is less than 0.05. "),
