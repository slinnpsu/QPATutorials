...
```{r analysis-practice-rural-table, exercise = TRUE, exercise.lines=4, exercise.cap="Interactive exercise: Write code from scratch to create a frequency table for the rural variable. Click Submit Answer to check correctness."}
...
```{r visual-practice-bar-rural, exercise=TRUE, exercise.cap="Interactive exercise: Create a bar chart for the rural_urban variable. Fill in the XXXX placeholders and click Submit Answer to check correctness."}
...
```{r analysis-practice-fhstatus-freq, exercise = TRUE, exercise.lines=4, exercise.cap="Interactive exercise: Write code from scratch to create a frequency and proportion table for the FHStatus variable. Name the new columns 'freq' and 'prop'. Click Submit Answer to check correctness."}
...
```{r analysis-practice-fhstatus-median, exercise=TRUE, exercise.cap="Interactive exercise: Write the code to calculate the median for the FHStatus variable. Remember to handle missing values. Click Submit Answer to check correctness."}
...
```{r visual-practice-fhstatus-freq-bar, exercise=TRUE, exercise.cap="Interactive exercise: Write ggplot code from scratch to plot FHStatus. See the text prompt for specific instructions on titles, labels, and axis scales. Click Submit Answer to check correctness."}
...
```{r visual-practice-fhstatus-prop-bar, exercise=TRUE, exercise.cap="Interactive exercise: Modify the plot to show proportions instead of frequencies. Fill in the XXXX placeholders and click Submit Answer to check correctness."}
ggplot(data = fHouse,  mapping = aes(x = factor(FHStatus))) +
...
To obtain proportions specify aes(y = after_stat(prop), group = 1)) inside geom_bar().
Be careful to match parentheses.
```
