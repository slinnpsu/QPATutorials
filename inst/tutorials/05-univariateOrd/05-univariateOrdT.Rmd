...
First, we will generate a frequency and proportion table using the [dplyr]{.package-name} functions.  You do not need to load the package again because we've done so in an earlier exercise.  See if you can produce the table without looking at the hints. Name the counts variable **freq** and the proportion variable **prop**.
