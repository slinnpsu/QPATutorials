...
question("Which of the following variables are interval (or ratio) level measures?",
  ...
  answer("The homocide rate in a country is a year", correct = TRUE, message="The level of foreign direct investment and homocide rate take values that are both rank-ordered and the differences between values are equivalent. Therefore both variables are measured at the interval level. "),
