...
```{r rename-hint}
1. First, you need to figure out which elements (which
...
2. Then you will need to use square brackets to
surround the index values you just identified. 
3. Inside those square brackets, you will need to use
the concatenate function. This specifies the index
values you wish to replace.
4. Then assign the replacement candidate. Be sure to
