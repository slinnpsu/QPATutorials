...
question_text(
  ...
  answer("p<2.23-16", message = "Do not report scientific notation or more than three decimals."),
...
question("Which of the following statements are true?",
  ...
  answer("The mean proportion of Blacks in counties Trump won was 0.23", correct = FALSE, message="Group 1 refers to the second response option for TrumpMajority, which corresponds to a Trump majority. The average proportion of Blacks in counties Trump won is about 0.08."),
  answer("The counties that Clinton won had, on average, a 0.23 - 0.07 = 0.16 greater proportion that were Black than did counties Trump won.", correct = TRUE,  message="0.23 - 0.08 = 0.15 is the difference in the mean proportion black in counties Clinton won, group 0, and counties Trump won, group 1."),
  answer("", message=""),
  allow_retry = TRUE,
  try_again = "Hint: Make sure to select all true statements."
  )
...
question("What substantive conclusion can we draw from this hypothesis test?",
  ...
  answer("On average, democracies and nondemocracies do not have significantly different GDP values in 2008", correct=TRUE, message = "Although the estimated means show that democracies have a higher average GDP in 2008 than nondemocracies, we cannot be 95% confident that this is true in the population."),
  allow_retry = TRUE,
  try_again = ""
  )
```
