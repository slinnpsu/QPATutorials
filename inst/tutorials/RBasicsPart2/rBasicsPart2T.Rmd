...
Look carefully at this code, we will be using the `which()` function frequently this semester to identify cases (e.g., states or countries) that have the maximum (or minimum) value of a given variable!
