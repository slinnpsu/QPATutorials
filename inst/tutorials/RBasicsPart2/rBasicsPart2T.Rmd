...
library(RCurl)
library(datasets)
Counties <- QMA::counties2016
library(gradethis)
tutorial_options(exercise.checker = gradethis::grade_learnr)
#tutorial_options(exercise.timelimit = 60)
knitr::opts_chunk$set(error = TRUE)
unFBposts<-QMA::unFBPosts
turnout <- QMA::turnout2
oil <- QMA::oilwomen.dta
```
...
For example, to see the 3rd row in the 2nd colum of **unFBposts** we use square brackes and list the row, followed by a comma, and the column:
