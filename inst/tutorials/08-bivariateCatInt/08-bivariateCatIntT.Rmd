...
::: {.hypothesis}
In a comparison of [counties], those having [lower wage growth] will be more likely to  [give a majority of their support to Trump] than will those having [lower wage growth].
:::
...
We might also believe that counties with worse health outcomes punish the incumbent party. The data frame **counties** also contains the variable **mortality_risk_25_45_change**, which gives the change in the probability of dying in this particular age range (in percent), given that one is in that age range and has made it thus far, compared to the same probability four years ago. We thus might hypothesize: [ In a comparison of [counties], those having [higher mortality risk among adults 45-45 than 4 years ago] will be more likely to  [give a majority of their support to Trump] than will those having [lower mortality risk among adults 45-45].]{.hypothesis}
...
As a final example, consider the hypothesis: [ In a comparison of [countries], those that [are more democratic] will be more likely to  [have better economic outcomes] than will those that are [less democratic].]{.hypothesis} 
