...
[**An interval variable**]{.important-text} takes values that have a natural order [**and**]{.important-text} the differences between values are equal. Examples include anything measured in dollars, like GDP; percentages, like unemployment; or anything that you can count, like the number of terrorist acts.  
