...
```{r nominal-variable-question, echo=FALSE, exercise.cap="Interactive quiz: Identify which options are nominal (unordered categories). Choose two and use Run Code to check; retries allowed."}
...
```{r ordinal-variable-question, echo=FALSE, exercise.cap="Interactive quiz: Identify which options are ordinal (rank-ordered categories). Choose two and use Run Code to check; retries allowed."}
...
```{r interval-variable-question, echo=FALSE, exercise.cap="Interactive quiz: Identify which options are interval or ratio (ordered with meaningful differences). Choose two and use Run Code to check; retries allowed."}
...
```{r majority-measurment-question, echo=FALSE, exercise.cap="Interactive quiz: Determine the measurement level for a binary majority indicator (yes/no). Use Run Code to submit; retries allowed."}
...
```{r percentage-measurment-question-1, echo=FALSE, exercise.cap="Interactive quiz: Determine the measurement level for a percentage variable. Use Run Code to submit; retries allowed."}
...
```{r scale-measurment-question, echo=FALSE, exercise.cap="Interactive quiz: Classify a 1 to 7 ideology scale by measurement level. Use Run Code to submit; retries allowed."}
...
```{r percentage-measurment-question-2, echo=FALSE, exercise.cap="Interactive quiz: Determine the measurement level for a voting-with-leadership percentage. Use Run Code to submit; retries allowed."}
...
<p role="status" aria-label="Congratulations! You successfully completed this section."
