...
1.  Tell `ggplot()` the data that contains the variable(s) to plot. This time we need to specify a variable for each the x and y axis. By convention, the outcome variable is on the y-axis. 
