...
Try to complete the code below to plot the mean **mortality_risk_25_45_change** for counties Trump won and Clinton won by completing the code. Use "Mean Change in Mortality Risk Among Counties \nCasting a Majority of Votes for Clinton and Trump"" for the title of the plot and label the y-axis "Change in Mortality Risk". Specify the caption as "Source: Linn, Nagler, and Zilinsky". Label the x-axis tick marks "Clinton" and "Trump" and omit the x-axis title.
...
Finally, try to produce the plot of mean GDP, **gdp08**, by the level of democracy, **dem_level4** from the **world** data frame. Set the title for the plot to "Mean GDP by Level of Democracy" and label the y-axis "Mean GDP". You do not need to adjust the y-axis limits. Label the x-axis tick marks (in order) "Full Democracy", "Partial Democracy", "Hybrid", and "Authoritarian". Omit the x-axis title.
