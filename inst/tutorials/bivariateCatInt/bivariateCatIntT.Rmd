...
Finally, try to produce the plot of mean GDP, **gdp08**, by the level of democracy, **dem_level4** from the **world** data frame. Add titles to your plot. You do not need to adjust the y-axis limits.
